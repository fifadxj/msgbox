...
<html>
<head>
  <title><spring:message code="message.edit.title" /></title>
...
<spring:url value="/web/message/editSubmit.html" var="editSubmit" htmlEscape="true"/>
<form:form action="${editSubmit}" method="post" id="_form" modelAttribute="command">
<form:input path="id" type="hidden" />
<div class="content-box">
  <div class="content-box-header">
    <h3><spring:message code="message.edit.title" /></h3>
  </div>
