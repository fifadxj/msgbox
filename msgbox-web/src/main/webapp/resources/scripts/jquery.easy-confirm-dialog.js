...
(function($) {
    $.easyconfirm = {};
    $.easyconfirm.locales = {
        title: i18n.easyconfirm.title,
        text: i18n.easyconfirm.text,
        button: [i18n.easyconfirm.button.cancel, i18n.easyconfirm.button.confirm],
        closeText: i18n.easyconfirm.closeText
    };
